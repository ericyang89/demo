...
it("resolution handler is called when promise is resolved", function (done) {
  var testString = "foo";
  var promise = new _index.default(function (resolve) {
    setTimeout(function () {
      resolve(testString);
    }, 20);
  });
...
it("rejection handler is called when promise is rejected", function (done) {
  ...
  var promise = new _index.default(function (resolve, reject) {
    setTimeout(function () {
      reject(testError);
    }, 20);
  });
...
it("rejections are passed downstream", function (done) {
  var testError = 'eeeee'; // new Error("Something went wrong");
...
it("rejecting promises returned from resolution handlers are caught properly", function (done) {
  ...
  promise.then(function () {
    return new _index.default(function (resolve, reject) {
      setTimeout(function () {
        reject(testError);
      }, 20);
    });
...
it("rejection handlers catch synchronous errors in the executor function", function (done) {
  var testError = new Error("Something went wrong");
  var promise = new _index.default(function () {
    throw testError;
  });
  promise.then(function () {
    return new _index.default(function (resolve) {
